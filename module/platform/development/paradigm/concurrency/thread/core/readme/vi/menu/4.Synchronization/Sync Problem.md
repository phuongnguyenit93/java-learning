# 👻 Instruction Reordering: Con ma trong Đa luồng
...
---
# 🤝 Happens-Before: Bản hợp đồng Nhất quán Bộ nhớ
...
# Tìm hiểu về Dữ liệu mờ ảo (Stale Data)
...
---
# Tại sao khó test lỗi Stale Data trên CPU i7?
...
# Khoảnh khắc "Aha!" và Kỹ thuật Hoisting trong JIT
...
# Visibility (Tính hiển thị) trong Lập trình đa luồng
...
---
# Race Condition: Cơn ác mộng của lập trình đa luồng
...
# Deadlock (Khóa chết) trong Lập trình đa luồng
