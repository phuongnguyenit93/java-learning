...
## Menu
- [Phân phối Luồng (Thread) vs. Điều phối Kết quả (Result)](#async-thread-basic)
- [Phân biệt Thread và Lập trình bất đồng bộ (Asynchronous)](#thread-and-asynchronous)
- [CompletableFuture: Từ Điều khiển Luồng đến Chuỗi giá trị (Pipeline)](#pipeline-completable-future)
- [Cẩm nang làm chủ CompletableFuture (CF)](#completable-future-method)
- [Kết hợp CompletableFuture với Custom Thread Pool](#completable-future-with-custom-pool)
- [Bản chất của "Sự tự động" trong CompletableFuture](#fork-join-pool)
- [ Phân biệt thenApply vs. thenApplyAsync](#async-and-sync-completable-future)
- [Chuyên sâu về Cơ chế Tiếp sức (Sequential) trong CompletableFuture](#sequential-completable-future)
